...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mmongodb+srv://daemonics:Rangergamer9@filesharexbot.8jucdft.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5959856762").split()):
        ADMINS.append(int(x))
except ValueError:
